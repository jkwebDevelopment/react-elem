                ...
                <section className="tip-text-container">
                    ...
                    {this.props.logout('wait')?
                        <div className="logout">
                            <div onClick={this.handleClick.bind(this)}>再等等</div>
                            <div onClick={this.handleLogout.bind(this)}>狠心离开</div>
                        </div>
                        :<div className="confirm" onClick={this.handleClick.bind(this)}>确认</div>
                    }
                </section>
            </div>
        )
